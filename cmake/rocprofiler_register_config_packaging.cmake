...
foreach(COMPONENT_GROUP ${ROCPROFILER_REGISTER_COMPONENT_GROUPS})
    ...
    string(REPLACE ";" ", " CPACK_DEBIAN_${UCOMPONENT}_PACKAGE_DEPENDS "${CPACK_DEBIAN_${UCOMPONENT}_PACKAGE_DEPENDS}")
    set(CPACK_RPM_${UCOMPONENT}_PACKAGE_NAME "${PROJECT_NAME}${_SEP}${_NAME}")
    set(CPACK_RPM_${UCOMPONENT}_PACKAGE_REQUIRES "${_DEP}")
    string(REPLACE ";" ", " CPACK_RPM_${UCOMPONENT}_PACKAGE_REQUIRES "${CPACK_RPM_${UCOMPONENT}_PACKAGE_REQUIRES}")
